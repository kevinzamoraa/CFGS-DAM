--   CREACION DE LAS TABLAS VUELOS Y PASAJEROS NECESARIAS PARA LA TAREA: 


-- ELIMINACIÓN DE LAS TABLAS VUELOS Y PASAJEROS
...
CREATE TABLE PASAJEROS (
  ...
  FOREIGN KEY (COD_VUELO) REFERENCES VUELOS(COD_VUELO) ON DELETE CASCADE
);
